...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-40">
      <nav className="bg-cream-100/90 backdrop-blur-md border-b border-cream-300/60 transition-all" aria-label="Navigasi Utama">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          
          <Link href="/" className="font-serif tracking-widest text-lg font-bold text-charcoal-900 uppercase" aria-label="Optik Intercontinental - Beranda">
          ...
          <div className="flex items-center gap-6">
            ...
            <button
              ...
              aria-label={`Buka keranjang belanja, ${items.length} item`}
            >
